...
namespace Windows.UI.Xaml.Media
{
    ...
    public static class VisualTreeHelperExtensions
    {
        ...
        /// <summary>
        /// Returns the effective scale of a Viewbox if the template is loaded.
        /// </summary>
        /// <param name="viewbox"></param>
        /// <returns></returns>
        public static (double X, double Y) GetContentScale(this Viewbox viewbox)
        {
            if (viewbox.GetFirstDescendantOfType<Border>() is Border b
                && b.RenderTransform is ScaleTransform s)
                return (s.ScaleX, s.ScaleY);

            // If the Viewbox is not loaded, content is at default scale
            return (1d, 1d);
        }
    }
}