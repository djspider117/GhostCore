...
namespace GhostCore.Numerics
{
    ...
    /// <summary>
    /// Defines a set of Cubic Bezier control points that can be used to create KeySplines
    /// or Composition CubicBezier easing functions
    /// </summary>
    public struct CubicBezierControlPoints
    {
        public Vector2 ControlPoint1 { get; }
        public Vector2 ControlPoint2 { get; }

        public CubicBezierControlPoints(Vector2 controlPoint1, Vector2 controlPoint2)
        {
        ...
        /// <summary>
        /// Returns control points representing a Penner Equation
        /// </summary>
        /// <param name="type"></param>
        /// <param name="variation"></param>
        /// <returns></returns>
        public static CubicBezierControlPoints CreatePenner(PennerType type, PennerVariation variation)
        {
            ...
            return new CubicBezierControlPoints(controlPoint1, controlPoint2);
        }
    }
}
